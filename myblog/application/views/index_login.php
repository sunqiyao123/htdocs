...
<div id="OSC_Screen"><!-- #BeginLibraryItem "/Library/OSC_Banner.lbi" -->
	...
	<div id="OSC_Topbar">
		<div id="VisitorInfo">
			...
			<a href="We/inbox" class="msgbox" title="进入我的留言箱">你有<em><?php echo $count;?></em>新留言</a>
			</span>
		</div>
		<div id="SearchBar">
			<form action="Search">
			...
			<ul>
				<?php foreach ($list as $article){?>
					<li class='Blog' id='blog_24027'>
						...
						<h2 class='BlogAccess_true BlogTop_0'><a href="We/blog_detail?id=<?php echo $article->article_id?>"><?php echo $article->title?></a></h2>
						...
						<div class='TextContent' id='blog_content_24027'>
							...
							<div class='fullcontent'><a href="We/blog_detail?id=<?php echo $article->article_id?>">阅读全文...</a></div>
